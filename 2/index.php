                ...
                <div class="result__main">
                    ...
                    <div class="result__share"><b class="result__share-name">Поделиться результатом:</b>
                        <div class="result__share-icons">
                            <li class="social__item"><a class="social__link" href="#" target="_self" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                            <li class="social__item"><a class="social__link" href="#" target="_self" title="VK"><i class="fab fa-vk"></i></a></li>
                        </div>
